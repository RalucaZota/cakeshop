<template>
    <article class="product-article" v-for="{id, image, name, price, quantity, description, ingredients, raiting} in  singleProduct" :key="id">
        ...
        <div class="product-wrapper-div-details"> 
            <h3>{{ name }}</h3>
            <div class="star-raiting">{{ raiting }}</div>
            <h2>{{ price }}</h2>
