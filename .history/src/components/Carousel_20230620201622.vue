<template>
  <Carousel  :wrap-around="true" class="carousel" style="margin-top: 150px;">
    <Slide v-for="( clientInfo, id) in ClientsInfo" :key="id" >{{ clientInfo.opinion }}
      <div class="carousel__item" style="background-color: pink;">

        <slot  name="clientInfo" :clientInfo="clientInfo"></slot>
      </div>
      </Slide>
