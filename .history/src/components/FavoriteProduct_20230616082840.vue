...
.carousel__slide--active {
  ...
  -webkit-box-shadow: -10px 0px 13px -7px #000000, 10px 0px 13px -7px #000000, 0px 25px 9px -12px rgba(0,0,0,0.3); 
    box-shadow: -10px 0px 13px -7px #000000, 10px 0px 13px -7px #000000, 0px 25px 9px -12px rgba(0,0,0,0.3);
}
</style>
