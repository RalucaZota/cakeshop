  ...
  <header :class="{ 'scrolled-nav': scrolledNav }">
    <nav >
      ...
      <ul class="navigation" v-show="!mobile">
        ...
        <div class="icon">
          <font-awesome-icon icon="fa-solid fa-bars" size="lg" @click="openMobileNav" v-show="showIcon && mobile"  class="burger" :class="{'icon-active': mobileNav}"/>
          <font-awesome-icon  v-show="!showIcon && windowWidth <= 749" icon="fa-solid fa-xmark" size="xl" @click="closeMobileNav" :class="{'icon-active': !showIcon}"  />
        </div>
